...
namespace ColegioParroquialInmaculada
{
    public partial class Form1 : Form
    {
        ...
        private System.Drawing.Color BorderColor = Color.RoyalBlue;
        ...
        private void ControlRegionAndBorder(Control control, float radius, Graphics graph, Color borderColor)
        {
            ...
            using (System.Drawing.Pen penBorder = new System.Drawing.Pen(borderColor, 1))
            {
                graph.SmoothingMode = SmoothingMode.AntiAlias;
        ...
        {
            using (GraphicsPath roundPath = GetRoundedPath(rect, RadioBorde))
            using (Pen penBorder = new System.Drawing.Pen(color, 3))
            {
                graph.DrawPath(penBorder, roundPath);
            }
        }
        ...
        private void Form1_Paint_1(object sender, PaintEventArgs e)
        {
            ...
            FormRegionAndBorder(this, RadioBorde, e.Graphics, BorderColor, bordersize);
